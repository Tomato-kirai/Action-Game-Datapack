execute if items entity @s weapon.mainhand *[custom_data~{id:"guardian"}] if score @s player.weapon_point matches 500.. run function main:world/item/gun/guardian/ability/use
