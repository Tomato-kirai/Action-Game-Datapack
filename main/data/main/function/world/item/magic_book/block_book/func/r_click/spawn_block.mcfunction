...
summon block_display ~ ~40 ~ {Tags:["PurpleBlockMeteor","this"],block_state:{Name:"purple_concrete"},transformation:{translation:[-2f,-2f,-2f],left_rotation:[0f,0f,0f,1f],scale:[4f,4f,4f],right_rotation:[0f,0f,0f,1f]},teleport_duration:1}
...
playsound block.end_portal.spawn player @a ~ ~ ~ 0.25 2
