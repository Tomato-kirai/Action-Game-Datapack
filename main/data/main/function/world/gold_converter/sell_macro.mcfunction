...
$execute store result score @s gold_converter.gold_temp run data get entity @s EnderItems[{Slot:$(slot)b}].components.minecraft:custom_data.gold_value 1
$execute store result score @s gold_converter.count run data get entity @s EnderItems[{Slot:$(slot)b}].count 1
$execute if data entity @s EnderItems[{Slot:$(slot)b}].components.minecraft:custom_data.gold_value run item replace entity @s enderchest.$(slot) with air
