...
execute at @s as @e[tag=Monster,tag=!Boss,tag=Locked,distance=..31] run function main:world/entity/player/lock_entity/unlock

execute at @s as @e[tag=Mob,distance=..31] run function main:world/entity/player/lock_entity/unlock