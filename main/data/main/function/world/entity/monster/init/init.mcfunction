...
execute if score @s monster.level_random matches 21..40 run function main:world/entity/monster/init/level/lvl_1
execute if score @s monster.level_random matches 41..80 run function main:world/entity/monster/init/level/lvl_2
...
execute if score @s monster.level_random matches 161..200 run function main:world/entity/monster/init/level/lvl_5
execute if score @s monster.level_random matches 201.. run function main:world/entity/monster/init/level/lvl_5
