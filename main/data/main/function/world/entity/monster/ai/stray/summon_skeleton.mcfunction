...
summon skeleton ~ ~ ~ {Health:1f,Tags:["Monster","Skeleton","Level1","SetEquipment"],attributes:[{id:"max_health",base:1},{id:"movement_speed",base:0.1}],DeathLootTable:"none",CustomName:{"text": "インフィニティサモンスケルトン","italic": false,"color": "white"},CustomNameVisible:1b}
