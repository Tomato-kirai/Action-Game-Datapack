#> main:world/entity/monster/ai/river_zombie/step
...
execute rotated as @s positioned 0.0 0.0 0.0 run summon area_effect_cloud ^ ^0.3 ^2 {Tags:["this"],Duration:6,Age:4}
