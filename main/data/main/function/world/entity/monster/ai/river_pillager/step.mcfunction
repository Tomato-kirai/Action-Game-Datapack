#> main:world/entity/monster/ai/river_pillager/step
...
execute rotated as @s positioned 0.0 0.0 0.0 run summon area_effect_cloud ^1 ^0.1 ^2 {Tags:["this"],Duration:6,Age:4}
