#> main:world/entity/monster/ai/infected_slime/shoot

tp @s ~ ~ ~ facing entity @p feet

summon armor_stand ~ ~1 ~ {Invisible:1b,Tags:["SlimeBall","Monster"],Silent:1b}

execute rotated as @s positioned 0.0 0.0 0.0 run summon area_effect_cloud ^ ^1 ^1.5 {Tags:["Motion"],Duration:6,Age:4}
