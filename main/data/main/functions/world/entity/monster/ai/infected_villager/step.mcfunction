#> main:world/entity/monster/ai/infected_villager/step
...
execute rotated as @s positioned 0.0 0.0 0.0 run summon area_effect_cloud ^ ^0.2 ^1.2 {Tags:["this"],Duration:6,Age:4}
