#> main:world/entity/monster/ai/dark_skeleton/back_step
...
execute rotated as @s positioned 0.0 0.0 0.0 run summon area_effect_cloud ^ ^0.3 ^-0.8 {Tags:["this"],Duration:6,Age:4}
