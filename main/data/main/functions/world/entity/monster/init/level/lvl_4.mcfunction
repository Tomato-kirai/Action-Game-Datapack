...
attribute @s generic.max_health modifier add b4d7f578-b14e-47ef-87ec-8c60e1d65144 "ModHealth" 41 add
data merge entity @s {Health:2097152}

attribute @s generic.armor modifier add 768b749e-0bb4-4bbd-b28a-11d84d336be6 "ModArmor" 26 add
