#> main:world/item/magic_book/wind_book/func/l_click/damage

scoreboard players set @p[tag=this,limit=1] player.status.weapon_damage 8
...
function main:world/item/magic_book/wind_book/func/l_click/damage_macro with storage temp: