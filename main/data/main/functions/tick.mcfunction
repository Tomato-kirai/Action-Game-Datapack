...
execute as @e[tag=Monster] at @s run function main:world/entity/monster/tick
...
execute as @e[type=armor_stand] if entity @s[tag=SpawnArea] at @s if entity @p[distance=..48] run function main:world/spawn_area/marker/main
