...
execute unless data entity @s Items[{Slot:2b}] run data modify block 0 -64 0 Items[{Slot:1b}].components."minecraft:custom_data" set value {empty:1b}
execute unless data entity @s Items[{Slot:3b}] run data modify block 0 -64 0 Items[{Slot:2b}].components."minecraft:custom_data" set value {empty:1b}
execute unless data entity @s Items[{Slot:4b}] run data modify block 0 -64 0 Items[{Slot:3b}].components."minecraft:custom_data" set value {empty:1b}

execute unless data entity @s Items[{Slot:11b}] run data modify block 0 -64 0 Items[{Slot:4b}].components."minecraft:custom_data" set value {empty:1b}
execute unless data entity @s Items[{Slot:12b}] run data modify block 0 -64 0 Items[{Slot:5b}].components."minecraft:custom_data" set value {empty:1b}
execute unless data entity @s Items[{Slot:13b}] run data modify block 0 -64 0 Items[{Slot:6b}].components."minecraft:custom_data" set value {empty:1b}

execute unless data entity @s Items[{Slot:20b}] run data modify block 0 -64 0 Items[{Slot:7b}].components."minecraft:custom_data" set value {empty:1b}
execute unless data entity @s Items[{Slot:21b}] run data modify block 0 -64 0 Items[{Slot:8b}].components."minecraft:custom_data" set value {empty:1b}
execute unless data entity @s Items[{Slot:22b}] run data modify block 0 -64 0 Items[{Slot:9b}].components."minecraft:custom_data" set value {empty:1b}