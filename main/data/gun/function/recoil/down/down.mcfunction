...
execute if score @s gun.recoil_down matches 2..7 run function gun:recoil/down/2
execute if score @s gun.recoil_down matches 8..15 run function gun:recoil/down/4
execute if score @s gun.recoil_down matches 16..63 run function gun:recoil/down/16
execute if score @s gun.recoil_down matches 64..127 run function gun:recoil/down/32
execute if score @s gun.recoil_down matches 128.. run function gun:recoil/down/64
